...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya3 печать чека l');

test('testing i-i-s-kursovaya3-печать-чека-l', function(assert) {
  visit('/i-i-s-kursovaya3-печать-чека-l');
