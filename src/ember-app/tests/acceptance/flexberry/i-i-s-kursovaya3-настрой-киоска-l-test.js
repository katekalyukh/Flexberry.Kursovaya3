...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya3 настрой киоска l');

test('testing i-i-s-kursovaya3-настрой-киоска-l', function(assert) {
  visit('/i-i-s-kursovaya3-настрой-киоска-l');
