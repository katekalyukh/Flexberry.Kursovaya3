...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya3 оператор l');

test('testing i-i-s-kursovaya3-оператор-l', function(assert) {
  visit('/i-i-s-kursovaya3-оператор-l');
