...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya3 фото киоск l');

test('testing i-i-s-kursovaya3-фото-киоск-l', function(assert) {
  visit('/i-i-s-kursovaya3-фото-киоск-l');
